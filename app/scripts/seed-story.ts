...
const USERS: UserDef[] = [
  ...
  { githubId: 2007, login: "sam-thornton", name: "Sam Thornton", type: "human", role: "user" },
...
const PAPERS: PaperDef[] = [
  ...
  { key: "p02", title: "Island-Model Migration as a Symmetric Monoidal Functor",
    ...
    reviewers: [
      { login: "sam-thornton", scores: [0,0,0,0,0], summary: "", strengths: "", weaknesses: "", verdict: "pending" },
  ...
  { key: "p11", title: "Multi-Agent Consensus via Categorical Message Passing",
    ...
    reviewers: [
      ...
      { login: "sam-thornton", scores: [4,5,3,4,4], summary: "A careful treatment of consensus through categorical lenses. The limit characterization is elegant and the proofs are correct.", strengths: "The mathematical framework is clean and well-motivated. The enriched category construction captures the essential structure of the problem.", weaknesses: "The writing is occasionally too terse. Several proofs that are 'left to the reader' should be included, at least in an appendix.", verdict: "accept" },
    ] },
  ...
  { key: "p15", title: "Polynomial Functors and Evolutionary Operators",
    ...
    category: "research", targetStatus: "published", authors: ["sam-thornton"],
  ...
  { key: "p16", title: "Containers: An Expository Account for Computer Scientists",
    ...
    category: "expository", targetStatus: "published", authors: ["sam-thornton"],
  ...
  { key: "p17", title: "Induction-Recursion for Self-Modifying Genetic Programs",
    ...
    category: "research", targetStatus: "under-review", authors: ["sam-thornton"],
...
const NOTES: Array<[string, string, string, number | null]> = [
  ...
  ["p01", "sam-thornton", "The polynomial functor framework might give you compositionality for free here. If each topology schedule is a polynomial endofunctor, composition of schedules corresponds to composition of functors — and you inherit all the coherence laws automatically.", 2],
  ...
  ["p06", "sam-thornton", "Theorem 3.2 has a small gap — the naturality square commutes only up to a coherence isomorphism, not strictly. This is easily fixed by working in a bicategory instead of a strict 2-category. Happy to discuss offline.", null],
  ["p06", "GayleJewson", "Thank you Sam — you're right, and the fix is straightforward. We'll update in the next revision. The bicategorical treatment actually strengthens the result.", 5],
  ...
  // Paper 15 — Sam's polynomial functors
  ...
  ["p09", "sam-thornton", "I will be recommending this to all my students. The treatment of Schur functions through the RSK correspondence is particularly clear. Minor note: in Example 4.7, the third row of the tableau should be (2,3), not (2,4).", null],
...
const FAVOURITES: Array<[string, string]> = [
  ...
  ["p01", "sam-thornton"], ["p03", "sam-thornton"], ["p11", "sam-thornton"], ["p08", "sam-thornton"],
...
const READS: Array<[string, string]> = [
  ...
  ["p01", "sam-thornton"], ["p03", "sam-thornton"], ["p11", "sam-thornton"],
  ["p15", "sam-thornton"], ["p16", "sam-thornton"],
...
async function main() {
  ...
  try {
    ...
    await monkey(["editorial", "assign", underReview1, "sam-thornton", "--as", "RaggedR"], "double-assign same reviewer");
    ...
    await monkey(["review", "submit", underReview1, "--novelty", "9", "--correctness", "3", "--clarity", "3", "--significance", "3", "--prior-work", "3", "--verdict", "accept", "--summary", "Inflated", "--strengths", "None", "--weaknesses", "None", "--as", "sam-thornton"], "review with score > 5");
