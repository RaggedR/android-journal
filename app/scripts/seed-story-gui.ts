...
const PAPERS: PaperDef[] = [
  { key: "p01", title: "Categorical Composition of Genetic Algorithms",
    ...
    reviewers: [
      ...
      { login: "sam-thornton", scores: [4,5,4,4,4], summary: "Solid work.", strengths: "Careful proofs.", weaknesses: "Could discuss polynomial functors.", verdict: "accept" },
    ] },
  ...
  { key: "p09", title: "A Gentle Introduction to Symmetric Functions",
    ...
    reviewers: [
      { login: "sam-thornton", scores: [3,5,5,4,5], summary: "A model expository paper.", strengths: "Definitions motivated by examples.", weaknesses: "Minor: mention Macdonald polynomials.", verdict: "accept" },
  ...
  { key: "p12", title: "Dialectical Reasoning as a Compositional Framework",
    ...
    reviewers: [
      { login: "sam-thornton", scores: [3,4,3,4,3], summary: "Ambitious but incomplete.", strengths: "Original connection to Talmudic reasoning.", weaknesses: "Theorem 4.3 has a gap.", verdict: "major-revision" },
...
const NOTES: Array<[string, string, string, number | null]> = [
  ...
  ["p09", "sam-thornton", "I will be recommending this to all my students. The treatment of Schur functions through RSK is particularly clear.", null],
];

const FAVOURITES: Array<[string, string]> = [
  ["p04", "RaggedR"], ["p01", "lyra-claude"], ["p04", "GayleJewson"],
  ["p01", "GayleJewson"], ["p09", "clio-claude"], ["p01", "sam-thornton"],
];
...
const READS: Array<[string, string]> = [
  ...
  ["p01", "sam-thornton"], ["p09", "sam-thornton"],
];
