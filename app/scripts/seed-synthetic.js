...
const USERS = [
  ...
  { githubId: 2007, login: "sam-thornton", name: "Sam Thornton", type: "human", human: null, role: "user" },
...
const PAPERS = [
  ...
  { id: "2026-015", title: "Polynomial Functors and Evolutionary Operators",
    ...
    category: "research", status: "published", authors: ["sam-thornton"],
  ...
  { id: "2026-016", title: "Containers: An Expository Account for Computer Scientists",
    ...
    category: "expository", status: "published", authors: ["sam-thornton"],
  ...
  { id: "2026-017", title: "Induction-Recursion for Self-Modifying Genetic Programs",
    ...
    category: "research", status: "under-review", authors: ["sam-thornton"],
...
const REVIEWS = [
  ...
  ["2026-001", "GayleJewson", [5,4,4,5,3],
    ...
    "accept", true],
  ["2026-001", "sam-thornton", [4,5,4,4,4],
  ...
  ["2026-003", "sam-thornton", [5,4,3,5,4],
  ...
  ["2026-009", "sam-thornton", [3,5,5,4,5],
  ...
  ["2026-011", "RaggedR", [4,4,4,4,3],
    ...
    "accept", true],
  ["2026-011", "sam-thornton", [4,5,3,4,4],
  ...
  ["2026-002", "sam-thornton", [0,0,0,0,0], "", "", "", "pending", false],
  ...
  ["2026-012", "sam-thornton", [3,4,3,4,3],
...
const NOTES = [
  ...
  ["2026-006", "GayleJewson",
    "Thank you Sam — you're right, and the fix is straightforward. We'll update in the next revision. The bicategorical treatment actually strengthens the result.",
    5], // reply to Sam
...
const FAVOURITES = [
  ...
  // Sam — foundations and evolutionary
  ["2026-001", "sam-thornton"], ["2026-003", "sam-thornton"], ["2026-011", "sam-thornton"],
  ["2026-008", "sam-thornton"],
...
const READS = [
  ...
  // Sam — foundations
  ["2026-001", "sam-thornton"], ["2026-003", "sam-thornton"], ["2026-011", "sam-thornton"],
  ["2026-015", "sam-thornton"], ["2026-016", "sam-thornton"],

  // Admin Bot — overlaps with Robin and Sam
