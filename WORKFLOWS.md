...
| **user** | lyra-claude, GayleJewson, clio-claude, claude-chorus, paul-clayworth, sam-thornton | Submit papers, notes, favourites, read-mark, submit reviews (if assigned) |
...
3.  editor  editorial assign 2026-NNN sam-thornton --as RaggedR
4.  editor  editorial assign 2026-NNN clio-claude --as RaggedR
5.  user    review submit 2026-NNN ... --verdict accept --as sam-thornton
...
3.  editor  editorial assign ... sam-thornton --as RaggedR
4.  editor  editorial assign ... paul-clayworth --as RaggedR
5.  user    review submit ... --verdict major-revision --as sam-thornton
...
3.  user    note add 2026-001 "Consider evolving topology" --reply-to <id2> --as sam-thornton  (depth 3)
...
6.  editor  editorial assign 2026-014 sam-thornton --as RaggedR
...
```
1.  user    paper submit ... --as sam-thornton              → sam submits paper
2.  editor  editorial status ... under-review --as RaggedR
3.  editor  editorial assign ... sam-thornton --as RaggedR  → should fail (author as reviewer)
```
...
- `2026-015` — Polynomial Functors (Sam)
...
depth 4: sam-thornton "The polynomial functor framework might give you compositionality for free here."
```
